...
# =========================
JOB_NAME="train_clinic_student"
JOB_ID=$(date +"%Y%m%d_%H%M%S")   # fake job id using timestamp

OUT_DIR="logs_student_clinic"
mkdir -p ${OUT_DIR}
...
echo "Train Student on Clinic-DB dataset"
echo "==================================="
...
python train.py --config ./config_student/training_clinic.yaml
