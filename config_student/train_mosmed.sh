...
# =========================
JOB_NAME="train_mosmed_student"
JOB_ID=$(date +"%Y%m%d_%H%M%S")   # fake job id using timestamp

OUT_DIR="logs_student_mosmed"
mkdir -p ${OUT_DIR}
...
echo "Train Student on MosMedPlus dataset"
echo "==================================="
...
python train.py --config ./config_student/training_mosmed.yaml
