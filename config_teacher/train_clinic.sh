...
# =========================
JOB_NAME="train_clinic_teacher"
JOB_ID=$(date +"%Y%m%d_%H%M%S")   # fake job id using timestamp

OUT_DIR="logs_teacher_clinic"
mkdir -p ${OUT_DIR}
...
echo "Train Teacher on Clinic-DB dataset"
echo "==================================="
...
python train.py --config ./config_teacher/training_clinic.yaml
