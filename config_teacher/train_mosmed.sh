...
# =========================
JOB_NAME="train_mosmed_teacher"
JOB_ID=$(date +"%Y%m%d_%H%M%S")   # fake job id using timestamp

OUT_DIR="logs_teacher_mosmed"
mkdir -p ${OUT_DIR}
...
echo "Train Teacher on MosMed dataset"
echo "==================================="
...
python train.py --config ./config_teacher/training_mosmed.yaml
