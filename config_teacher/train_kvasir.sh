...
# =========================
JOB_NAME="train_kvasir_teacher"
JOB_ID=$(date +"%Y%m%d_%H%M%S")   # fake job id using timestamp

OUT_DIR="logs_teacher_kvasir"
mkdir -p ${OUT_DIR}
...
echo "Train Teacher on Kvasir dataset"
echo "==================================="
...
python train.py --config ./config_teacher/training_kvasir.yaml
