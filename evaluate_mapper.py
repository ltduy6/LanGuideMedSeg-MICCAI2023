import argparse
from engine.wrapper_mapper import MapperPretrainer
...
def get_parser():
    parser = argparse.ArgumentParser(
        description='Language-guide Medical Image Segmentation Mapper')
    parser.add_argument('--config',
                        default='./config_mapper/training_qatar.yaml',
                        type=str,
                        help='config file')
